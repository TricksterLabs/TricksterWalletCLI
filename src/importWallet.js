...
export async function importWallet(entropy) {
  // const words2 = 'squirrel razor tank unusual notable exhaust weird cherry cage rigid tattoo luggage filter bean pepper cream option cause media deputy cluster mixture exotic access';
